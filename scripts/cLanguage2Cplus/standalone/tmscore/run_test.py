#!/usr/bin/env python3
"""
TMscore regression test script
Switch to the USalign-beta branch, compile the modified TMscore, run all test cases, and compare byte-by-byte with baseline/.
Generated files: -o TM_sup produces TM_sup.pdb / TM_sup.pdb1 / *.pml (pml not compared). Restores the branch that was active before running.
"""
...
def run_tests(exe_path: str):
    ...
    with open(testcases, "r", encoding="utf-8") as f:
        for line in f:
            ...
            # Compare superposition structure files generated by -o TM_sup
